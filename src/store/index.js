...
import moduleEspecialista from "./especialistas/especialista.module";
import modulePatrocinador from "./patrocinadores/patrocinador.module";
...
export default new Vuex.Store({
  ...
  modules: {
    ...
    especialista:moduleEspecialista,
    patrocinador:modulePatrocinador
  }
});
