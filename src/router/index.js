...
const routes = [{
    ...
    },
    {
        ...
        name: "listEspecialistas",
        component: () => import("@/views/especialistas/ListEspecialistas.vue")
    },
    {
        path: "/admin/especialistas/:especialistaId",
        name: "editEspecialista",
        component: () => import("@/views/especialistas/EditEspecialista.vue")
    },
    {
        path: "/admin/especialistas/add",
        name: "addEspecialista",
        component: () => import("@/views/especialistas/AddEspecialista.vue")
    },
    {
        path: "/admin/patrocinadores",
        name: "listPatrocinadores",
        component: () => import("@/views/patrocinadores/ListPatrocinador.vue")
    },
    {
        path: "/admin/patrocinadores/:patrocinadorId",
        name: "editPatrocinador",
        component: () => import("@/views/patrocinadores/EditPatrocinador.vue")
    },
    {
        path: "/admin/patrocinadores/add",
        name: "addPatrocinador",
        component: () => import("@/views/patrocinadores/AddPatrocinador.vue")
    },
    {
        path: "/profile",
        name: "profile",
